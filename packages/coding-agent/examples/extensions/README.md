...
| `probe/` | Registers local Probe CLI tools including the higher-level `probe_core_method` workflow, with concise system guidance that prefers high-level entrypoint/core-method discovery before expert search tuning |
